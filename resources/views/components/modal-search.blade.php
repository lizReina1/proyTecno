<!-- Search button -->
<div id="searchComponent" class="relative inline-flex">
    <!-- Button -->
    ...
    <!-- Modal backdrop -->
    <div id="modalBackdrop" class="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity"
        style="display: none;" aria-hidden="true"></div>
    <!-- Modal dialog -->
    <div id="searchModal" class="fixed inset-0 z-50 overflow-hidden flex items-center justify-center px-4 sm:px-6"
        ...
        <div id="modalContent"
            ...
            <!-- Close button -->
            <button id="closeButton" class="absolute top-0 right-0 m-2">
