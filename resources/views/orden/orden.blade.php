                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <div>
                            <div class="flex items-center gap-x-3">
                                <h2 class="text-lg font-medium text-gray-800 dark:text-white">Orden</h2>
                                        ...
                                        <tbody
                                            ...
                                            @foreach ($ordens as $orden)
                                                <tr>
                                                    <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                        <div class="flex min-w-0 gap-x-4">
                                                            <img class="h-16 w-16 flex-none rounded-full bg-gray-50"
                                                                src="{{ $orden->url_foto }}" alt="">
                                                            <div class="min-w-0 flex-auto">
                                                                <p
                                                                    class="text-sm font-semibold leading-6 text-gray-900">
                                                                    {{ $orden->name }} {{ $orden->lastname }}</p>
                                                                <p
                                                    ...
                                                    <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                                        <div class="flex min-w-0 gap-x-4">
                                                            <div class="min-w-0 flex-auto">
                                                                <p
                                                                    class="mt-1 truncate text-xs leading-5 text-gray-500">
                                                                    {{ $orden->hora_inicio_atencion }}</p>
                                                                <p
                                                                    class="mt-1 truncate text-xs leading-5 text-gray-400">
                                                                    {{ $orden->hora_fin_atencion }}</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        <div>
                                                            <h4 class="text-gray-700 dark:text-gray-200">
                                                                {{date("Y-m-d", strtotime($orden->fecha_atencion)) }}</h4>
                                                    ...
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        {{ $orden->pagado==true? 'Pagado' : 'Impago'}}
                                                    </td>
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        <button
