                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700"
                                        ...
                                        <tbody
                                            ...
                                            @foreach ($servicios as $servicio)
                                                <tr data-tipo="{{ $servicio->forma_compra }}">
                                                    ...
                                                    <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                                        <div
                                                            ...
                                                            {{ $servicio->forma_compra }}
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        <div>
                                                            <h4 class="text-gray-700 dark:text-gray-200">
                                                                {{ $servicio->costo }} Bs</h4>
                                                    ...
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        <div class="flex items-center">
                                                            @php
                                                                $users = $usersPorServicio[$servicio->id];
                                                                $c = count($users);
                                                                $i = 1;
                                                            @endphp
                                                            @if ($c > 0)
                                                                @foreach ($users as $user)
                                                                    @if ($i < 5)
                                                                        <img class="object-cover w-8 h-8 -mx-1 border-2 border-white rounded-full dark:border-gray-700 shrink-0"
                                                                            src="{{ $user->url_foto }}?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80"
                                                                            alt="">
                                                                    @endif
                                                                    @php
                                                                        $i = $i + 1;
                                                                ...
                                                                @if ($c > 4)
                                                                    <p
                                                                        class="flex items-center justify-center w-8 h-8 -mx-1 text-xs text-blue-600 bg-blue-100 border-2 border-white rounded-full">
                                                                        +{{ $c - 4 }}</p>
                                                                @endif
                                                            @endif
                                                            {{-- @else
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div id="myDropdown" class="dropdown-content">
                                                                ...
                                                                <a href="{{ route('servicio.show', $servicio->id) }}"
                                                                    class="hover:bg-gray-200">Personal</a>
