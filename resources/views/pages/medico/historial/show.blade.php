                ...
                <form action="{{ route('medico_historial_store') }}" method="POST" enctype="multipart/form-data" id="formCita">
                    ...
                    <div class="space-y-12">
                        <div class="border-b border-gray-900/10 pb-4">
                            <h2 class="text-base font-semibold leading-7 text-gray-900">Ver Historial</h2>
                            <p class="mt-1 text-sm leading-6 text-gray-600">Visualizar historial</p>
                            ...
                            <br>
                            <h3>Datos Medicos</h3>
                            @foreach ($datos_medicos as $datos_medico)
