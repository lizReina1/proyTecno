            ...
            <section class="container px-4 mx-auto">
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center mt-4 gap-x-3">
                        ...
                        <a href="{{ route('citas.create') }}" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" id="tabla">
                                    <thead class="bg-gray-50 dark:bg-gray-800">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <a href="{{ route('citas.edit', $cita) }}" class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg dark:text-gray-300 hover:bg-gray-100">
